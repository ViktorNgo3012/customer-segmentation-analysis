...
An interactive Power BI dashboard was developed to transform the results of the customer segmentation analysis into an intuitive business intelligence solution. The dashboard integrates customer demographics, transaction data, RFM segmentation, and revenue metrics, enabling users to explore customer behaviour and business performance through interactive visualisations.

### Dashboard Overview

<p align="center">
  <img src="images/Customer_Segmentation_Dashboard.png" alt="Customer Segmentation Dashboard" width="1000">
</p>

The dashboard provides a high-level overview of customer performance while allowing users to filter and investigate customer segments and product brands. By combining summary KPIs with interactive visualisations, the dashboard supports rapid exploration of customer purchasing behaviour and revenue performance.
...
- **Revenue Trend Analysis**
  - Monthly revenue trend to monitor changes in sales performance over time.

- **Customer Segment Performance**
  - Revenue generated by each customer segment.
  - Comparative analysis of customer value across behavioural groups.

- **Brand Performance**
  - Revenue generated by individual product brands.
  - Identification of the highest-performing brands.

- **Customer Segment Summary**
  - Number of customers within each segment.
  - Total revenue generated.
  - Average order value.
  - Revenue trend indicators for each customer segment.

### Dashboard Capabilities

The interactive dashboard enables users to:

- Monitor overall business performance using key performance indicators.
- Compare the financial contribution of different customer segments.
- Evaluate revenue performance across product brands.
- Analyse revenue trends over time.
- Filter results dynamically by customer segment and brand.
- Support evidence-based marketing and customer relationship decisions through interactive business intelligence.

### Business Value

The Power BI dashboard consolidates the outputs of the data preparation, exploratory analysis, RFM analysis, and customer segmentation into a single interactive reporting solution. Rather than reviewing multiple datasets or analytical notebooks, decision-makers can quickly identify valuable customer groups, monitor business performance, and explore customer behaviour through dynamic visualisations.
---
